            ...
            <div class="ev-wrap type2">
                ...
                <div class="ev-btn-wrap">
                    ...
                    <div class="btn-wrap">
                        ...
                        <a href="{{ route('board', ['code' => 'event-schedule', 'year' => $year, 'month' => $month, 'gubun' => 'K']) }}" class="btn btn-ev ev-cate01 {{ (request()->gubun ?? '') == 'K' ? 'on' : '' }}">국내</a>
                        <a href="{{ route('board', ['code' => 'event-schedule', 'year' => $year, 'month' => $month, 'gubun' => 'O']) }}" class="btn btn-ev ev-cate02 {{ (request()->gubun ?? '') == 'O' ? 'on' : '' }}">국외</a>
                        @if(isAdmin())
                        ...
                        <div class="ev-list-con">
                            <div class="ev-con-wrap">
                                <div class="ev-con text-left">
                                    ...
                                    @if(!empty($row->place))
                                    <p class="place">
                                        <span class="ellipsis2">장소 : {{ $row->place }}</span>
                                    </p>
                                    @endif
                                </div>
