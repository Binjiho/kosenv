    ...
    <article class="sub-contents">
        <div class="sub-conbox inner-layer">
            ...
            <div class="m-hide">
                ...
                <form id="register-frm" method="post" action="{{ route('abstract.data',['work_code'=>$work_code]) }}" onsubmit="" data-sid="" data-case="abstract-check">
                    <fieldset>
                        ...
                        <div class="btn-wrap text-center">
                            <a href="javascript:$(form).submit();" class="btn btn-type1 color-type9">사전등록 인증 및 초록 등록하기 <img src="/target/202501/assets/image/sub/img_btn_abstract.png" alt="" class="right"></a>
                        </div>
                    </fieldset>
                </form>
            </div>
