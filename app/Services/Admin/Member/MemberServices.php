...
//            switch ($level) {
//                case 'NA':
//                    $query->where(['gubun'=>'N', 'grade'=>'A']);
//                    break;
//                case 'NB':
//                    $query->where(['gubun'=>'N', 'grade'=>'B']);
//                    break;
//                case 'SA':
//                    $query->where(['gubun'=>'S', 'grade'=>'A']);
//                    break;
//                case 'SB':
//                    $query->where(['gubun'=>'S', 'grade'=>'B']);
//                    break;
//                case 'SC':
//                    $query->where(['gubun'=>'S', 'grade'=>'C']);
//                    break;
//                case 'G':
//                    $query->where(['gubun'=>'G']);
//                    break;
...
//            }
        ...
        // 탈퇴(요청)회원 카운트
        $this->data['levelCnt']['withdraw'] = User::withTrashed()->where(['del_type'=>1])->count();
        // 삭제회원 카운트
        $this->data['levelCnt']['elimination'] = User::withTrashed()->where(['del_type'=>2])->count();
